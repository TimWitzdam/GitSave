...
export default function AddSchedulePopup() {
  ...
  return (
    <div
      id="add-schedule"
      className="p-4 opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 bg-black bg-opacity-50 grid place-content-center transition-opacity duration-300"
    >
      <form
